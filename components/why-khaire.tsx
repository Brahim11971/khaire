      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto lg:mx-0 lg:max-w-none">
          ...
          <div className="mb-12 lg:mb-16">
            <span className="text-sm tracking-wider text-muted block mb-2">POURQUOI KHAIRE</span>
            <h2 className="text-2xl lg:text-3xl font-light">Ce qui rend chaque pièce unique</h2>
          </div>
