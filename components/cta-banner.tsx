export function CtaBanner() {
  return (
    <section className="bg-[#3d5a45] text-white py-16 lg:py-20">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-white text-[#1a1a1a] text-sm tracking-wider hover:bg-[#f5f1eb] transition-colors"
            target="_blank"
