          ...
          <div className="flex items-center gap-1">
            ...
            <a
              ...
              className={`flex items-center justify-center w-10 h-10 rounded-full transition-colors ${
                isScrolled ? "hover:bg-[#f5f1eb]" : "hover:bg-white/10"
              }`}
              aria-label="Contacter sur WhatsApp"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg viewBox="0 0 24 24" className={`w-5 h-5 ${isScrolled ? "text-[#3d5a45]" : "text-white"}`} fill="currentColor">
            ...
            <button
              ...
              aria-label="Panier (0)"
            >
              <ShoppingBag size={20} className={isScrolled ? "text-[#1a1a1a]" : "text-white"} />
            </button>
          </div>
        </div>
      </div>
        ...
        <div className="lg:hidden bg-[#faf9f7] border-t border-[#e5e0d8]">
          <nav className="px-4 py-6 space-y-4">
            ...
            <div className="pt-4 border-t border-[#e5e0d8] flex items-center gap-4">
              <button type="button" className="text-sm font-medium text-[#1a1a1a]">
                FR
              </button>
              <button type="button" className="text-sm text-[#6b6b6b] hover:text-[#1a1a1a]">
                AR
              </button>
            </div>
          </nav>
