...
const productImages = [
  { src: "/images/hero-main.jpg", alt: "Le Jabador Khaire - Vue principale" },
    ...
    <section>
      ...
      {lightboxOpen && (
        <div className="fixed inset-0 z-[100] bg-black/95 lg:hidden">
          ...
          {/* Bottom Bar with Thumbnails and Order Button */}
          <div className="absolute bottom-0 left-0 right-0 pb-6 px-4">
            ...
            <div className="flex justify-center gap-2 mb-4">
              {productImages.map((img, index) => (
                <button
                  ...
                  className={`relative w-12 h-[60px] overflow-hidden rounded-sm transition-all ${
                    lightboxIndex === index 
                      ? "ring-2 ring-white" 
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 w-full py-3 bg-white/10 backdrop-blur-sm text-white text-xs tracking-[0.1em] hover:bg-white/20 transition-colors rounded-full border border-white/20"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
